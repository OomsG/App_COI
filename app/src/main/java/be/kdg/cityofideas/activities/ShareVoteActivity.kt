...
class ShareVoteActivity : AppCompatActivity() {
    ...
    private fun shareTweet(sharedUrl: String, message: String) {
        val url =
    ...
    private fun shareFacebook(sharedUrl: String, message: String) {
    ...
    private fun validFbShare(id: Int): Boolean {
        val votes = getVotes()
        var state = false
        votes.forEach {
    ...
    private fun validTweet(id: Int): Boolean {
        val votes = getVotes()
        var state = false
        votes.forEach {
