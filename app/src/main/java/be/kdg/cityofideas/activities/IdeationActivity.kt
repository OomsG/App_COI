...
class IdeationActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val projects =  intent.extras.getSerializable(PROJECT) as Projects
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ideation)
        initaliseViews(this, projects)

    }

    @SuppressLint("CheckResult")
    fun initaliseViews(context: Context , projects:Projects) {
        ...
        pagerAdapter = IdeationViewPagerAdapter(supportFragmentManager, projects.ProjectId)
        viewPager.adapter = pagerAdapter

        tabLayout.setupWithViewPager(viewPager)
        RestClient(context)
            .getPhases("phases/" + projects.ProjectId)
